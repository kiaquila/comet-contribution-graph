...
- [x] T002 Confirm all three action references remain immutable SHA pins.
...
- [x] T005 Run `pnpm run preflight` on the final local head.
...
- [ ] T007 Confirm every required GitHub gate is green and every review thread
      is resolved.
- [ ] T008 Observe the two-minute merge-ready hold and merge PR #47.
