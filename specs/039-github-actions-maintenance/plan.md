...
6. Hold the merge-ready state for two minutes and merge PR #47.

## Risks

- OSV Scanner v2.6.0 intentionally fails closed when a scan does not complete;
  the repository scan must remain green without weakening that behavior.
