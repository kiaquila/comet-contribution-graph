...
- `project/devops/branch-protection.md` — GitHub `main` protection contract and apply helper.
...
- `project/devops/unicorn-hub-adoption.md` — adopted vs intentionally skipped Unicorn Hub blueprint pieces.
